...
{
    /// <summary>
    /// Class contains default validation settings.
    /// </summary>
    internal static class ValidatorSettingsDefault
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly DateTime MinimalDate = new DateTime(1950, 1, 1);
        ...
        /// </summary>
        public static readonly short MinimalPersonalRating = -10000;

        /// <summary>
        /// Minimal possible salary.
        /// </summary>
        public static readonly decimal MinimalSalary = 0;
